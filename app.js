...
var org = nforce.createConnection({
  clientId: '3MVG9d3kx8wbPieFPrTnKjSgQn9Y3Ipr9KKY866M6yqF85_7g89IGttririxECH1mZhftS7I4RYREH4KKmh1J',
...
app.get('/oauth/_callback', function(req, res) {
  org.authenticate({code: req.query.code}, function(err, resp){
    if(!err) {
      ...
      app.locals.lightningEndPointURI = "https://cpscxh2--rwegner.lightning.force.com";
      res.redirect('/home');
    } else {
