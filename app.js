...
var org = nforce.createConnection({
  clientId: '3MVG9g9rbsTkKnAU171i5WNVs8Lx5UfxoXgSX_WyVCdcnyFJ8AbQ2HBMyUDs5vFQSFbMmvWsvkylxLc7p1h3G',
  clientSecret: '3318953071693625695',
...
app.get('/oauth/_callback', function(req, res) {
  org.authenticate({code: req.query.code}, function(err, resp){
    if(!err) {
      ...
      app.locals.lightningEndPointURI = "https://cpscxh1-dev-ed.lightning.force.com";
      res.redirect('/home');
    } else {
